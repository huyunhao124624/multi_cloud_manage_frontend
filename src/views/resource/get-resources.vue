<template>
  <div class="app-container">
    ...
    >
      <el-table-column label="资源ID" prop="id" sortable="custom" align="center" width="150" :class-name="getSortClass('id')">
      ...
      <el-table-column label="资源类型" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.resourceTypeName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="cpu核数" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.cpuNum }}</span>
        </template>
      </el-table-column>
      <el-table-column label="内存容量(GB)" width="400px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.memorySize }}</span>
        </template>
      </el-table-column>
      <el-table-column label="磁盘容量(GB)" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.diskSize }}</span>
        </template>
      </el-table-column>
      <el-table-column label="实例状态" width="200px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="密码" width="200px" align="center">
        <template slot-scope="{row}">
